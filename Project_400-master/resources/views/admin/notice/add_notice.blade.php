              ...
              <div class="card mb-4 align-self-xl-center">
                ...
                <div class="card-body align-items-center justify-content-between">
                  <form>
                    ...
                    <textarea class="form-control col-lg-6 font-weight-bold"></textarea>
                  </div>
                    ...
                    <textarea  rows="8" textarea class="form-control col-lg-6 form-control-lg" aria-label="With textarea"></textarea>
                  </div>
